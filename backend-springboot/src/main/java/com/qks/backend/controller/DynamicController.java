...
public class DynamicController {
     ...
     */
    @GetMapping("/one/{id}")
    public ResVO<Dynamic> getDynamicById(@RequestBody Dynamic dynamic) {
        return dynamicService.getDynamicById(dynamic);
    }
    ...
    public ResVO<PageVO<List<DynamicVO>>> getDynamicList(@RequestHeader("token") String token, @PathVariable("currentPage") Integer currentPage) throws ServiceException {
     ...
     */
    @PostMapping("/star")
    public ResVO<Map<String, Object>> starDynamic(@RequestHeader("token") String token, @RequestBody DynamicVO dynamicVO)
            throws ServiceException {
        return dynamicService.starDynamic(token, dynamicVO);
    }
